...
class AuthController extends Controller
{
    ...
    public function register(RegisterRequest $request)
    {
        ...
        return redirect()->route('home')->with('success', 'Добро пожаловать новый пользователь!');
    }
    ...
    public function login(LoginRequest $request)
    {
        ...
        return redirect()->route('home')->with('token', $token)->with('success', 'Вы успешно вошли в аккаунт!');
    }
