...
@section('title', 'LibraryAI | Обсуждения')
@section('content')
    <div class="search-and-filter">
        ...
        @auth
            <a href="{{route('discussions.create')}}" class="btn-create">Создать обсуждение</a>
            <div class="tooltip-container">
                ...
                <span class="tooltip-text">Если у вас есть вопросы - создайте обсуждение и пообщайтесь с пользователями!</span>
            </div>
        @endauth
    </div>
